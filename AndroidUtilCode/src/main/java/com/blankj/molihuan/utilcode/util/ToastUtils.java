...
import com.blankj.molihuan.utilcode.R;
...
public final class ToastUtils {
            ...
            if (isShowing()) {
                ...
                for (Activity activity : UtilsBridge.getActivityList()) {
                    ...
                    if (window != null) {
                        ...
                        View toastView = decorView.findViewWithTag(ToastUtils.TAG_TOAST + (sShowingIndex - 1));
                        if (toastView != null) {
                            try {
    ...
    static abstract class AbsToast implements IToast {
        ...
        public void setToastView(CharSequence text) {
            ...
            messageTv.setText(text);
            if (mToastUtils.mTextColor != ToastUtils.COLOR_DEFAULT) {
        ...
        private void setBg(final TextView msgTv) {
            ...
            } else if (mToastUtils.mBgColor != ToastUtils.COLOR_DEFAULT) {
